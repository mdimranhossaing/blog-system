...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
                ...
                @auth
                    ...
                    <li class="nav-item dropdown user-menu">
                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                            <img src="https://fiverr-res.cloudinary.com/t_profile_original,q_auto,f_auto/attachments/profile/photo/6acd9ecba14ddda86fc6cf85417e0213-1590061632555/0e3703af-d67d-475d-8a45-65e0da87e272.jpg"
                                class="user-image img-circle elevation-2" alt="User Image">
                            <span class="d-none d-md-inline">Md Imran Hossain</span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            ...
                            <li class="user-header bg-primary">
                                ...
                                <p>
                                    Md Imran Hossain - Web Developer
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; {{ date('Y') }} <a href="">Blog System</a>.</strong>
            All rights reserved.
