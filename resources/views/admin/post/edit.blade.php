        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Edit <small>Post</small></h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form id="quickForm" action="{{ route('posts.update', $post->id) }}" method="POST"
                    ...
                    <div class="row card-body">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="content" class="form-control" id="content" cols="30" rows="5"
                                    placeholder="Write something...">{{ old('content') ? old('content') : $post->content }}</textarea>
                                @error('content')
                                    <div class="form-text text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-3">
                            {{-- Post Thumbnail --}}
                            <div class="form-group">
                                <img class="edit-post-thumb img-fluid"
                                    src="{{ asset('post_thumbnails/' . $post->thumbnail) }}" alt="Post Thumbnail">
